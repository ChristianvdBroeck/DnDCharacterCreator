...
public class Gnome extends CharacterRace {
    ...
    // fields
    private Map<String, Integer> abilityScoreIncrease = Map.of("Intelligence", 2);
    private int speed = 25;
    private String size = "Between 3 and 4 feet";
    private String[] racialAbilities = { "Darkvision", "Gnome Cunning" };
